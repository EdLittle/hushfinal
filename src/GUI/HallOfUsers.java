...
public class HallOfUsers extends javax.swing.JPanel {
    ...
    private static Vector gold_scorers = new Vector();
    private static Vector silver_scorers = new Vector();
    private static Vector bronze_scorers = new Vector();
    private static Vector wood_scorers = new Vector();
     ...
     */
    private void initVectors() throws Exception{
   ...
   //     wood_scorers = new Vector();
        ...
        //In real life:
       /* gold_scorers = getGold() ;
        silver_scorers = getSilver();
        bronze_scorers = getBronze();
        wood_scorers = getWood();
   ...
   //        System.out.println("JHGuti");
     ...
     public static void updateStat()throws Exception{
    ...
    public static Vector getGold(){
        return gold_scorers;
    }
    public static Vector getSilver(){
        return silver_scorers;
    }
    public static Vector getBronze(){
        return bronze_scorers;
    }
    public static Vector getWood(){
        return wood_scorers;
    }
