...
public class HallOfUsers extends javax.swing.JPanel {
  ...
  //      updateStat();
   ...
   //     wood_scorers = new Vector();
      ...
      // System.out.println("Gold content: " + gold_scorers.get(x));
             }
       ...
       System.out.println("Wood: " + wood_scorers.toString());  
        ...
        for(Object name : gold_scorers){            
            System.out.println("SIngapore " + gold_scorers.size());
            gold_list.add((String) name);
        }
        System.out.println("afg " + gold_list.getItemCount());
        ...
        for(Object name : gold_list.getItems()){
